          ...
          <div class="row">
              ...
              <div class="col-md-3">
                  ...
                  <div class="card card-primary">
                      ...
                      <form action="{{route('admin.courseCreate')}}" method="post">
                        @csrf  
                          <div class="card-body">
                              <div class="form-group">
                                  <label for="exampleInputEmail1"> Enter Course _ Title </label>
                                  <input type="text" class="form-control" name="course_title" id="exampleInputEmail1"
                                      placeholder="Python" style="@error('course_title')
                                          border-color:red
                                      @enderror">
                              </div>
                            @error('course_title')
                            ...
                            <tbody>
                               @foreach($course_data as $item) 
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.course_edith', $item->id)}}" class = "btn btn-primary">Edith</a></td>
                                    <td><a href="{{route('admin.course_delete', $item->id)}}" class="btn btn-danger" onclick = "confirmation(event)">Delete</a></td>
                                </tr>
                              @endforeach 
                            </tbody>
                            <tfoot>
